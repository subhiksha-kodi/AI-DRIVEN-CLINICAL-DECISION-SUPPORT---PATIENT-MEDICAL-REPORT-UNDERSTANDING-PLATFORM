...
const { listAppointmentsForAdmin, updateAppointmentStatus } = require('../controllers/patient.appointment.controller');
const {
  uploadEhrExcel,
  getEhrPatients,
  updateEhrPatient,
...
router.get('/admin/appointments', listAppointmentsForAdmin);
