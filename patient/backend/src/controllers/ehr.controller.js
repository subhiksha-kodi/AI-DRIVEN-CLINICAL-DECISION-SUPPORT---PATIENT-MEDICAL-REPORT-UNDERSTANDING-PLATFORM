...
const COLUMN_MAPPING = {
  ...
  'healthcare expenses': 'healthcare_expenses',
...
const getEhrColumns = async (req, res, next) => {
  try {
    const columns = [
      ...
      { key: 'healthcare_expenses', label: 'Healthcare Expenses', type: 'number' },
      { key: 'healthcare_coverage', label: 'Healthcare Coverage', type: 'number' },
