...
const navItems = [
  ...
  { to: '/doctor/trend-analysis', icon: LineChart, label: 'Trend Analysis' },
  { to: '/doctor/ehr-analysis', icon: Activity, label: 'EHR Analysis' },
  { to: '/doctor/profile', icon: User, label: 'Profile' },
];

const DoctorSidebar = ({ isExpanded, onMouseEnter, onMouseLeave }) => {
  ...
  return (
    <aside
      className={`doctor-sidebar ${isExpanded ? 'expanded' : ''}`}
