...
const generateFallbackAnalysis = (summary) => {
  ...
  analysis += `### 5. Disease Severity Indicators\n`;
  ...
  analysis += `### 6. Final Risk Level: ${risk}\n`;
  analysis += risk === 'HIGH' 
  ...
  analysis += `### 7. Clinical Recommendations\n`;
  if (risk === 'HIGH') {
